        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="owl-carousel">
                    <div class="item">
                        <div class="partner-logo"><img src="<?= base_url('public/images/demo/partners-1.png') ?>" alt="partners"></div>
                    </div>
                    <div class="item">
                        <div class="partner-logo"><img src="<?= base_url('public/images/demo/partners-2.png') ?>" alt="partners"></div>
                    </div>
                    <div class="item">
                        <div class="partner-logo"><img src="<?= base_url('public/images/demo/partners-3.png') ?>" alt="partners"></div>
                    </div>
                    <div class="item">
                        <div class="partner-logo"><img src="<?= base_url('public/images/demo/partners-4.png') ?>" alt="partners"></div>
                    </div>
                    <div class="item">
                        <div class="partner-logo"><img src="<?= base_url('public/images/demo/partners-5.png') ?>" alt="partners"></div>
                    </div>
                    <div class="item">
                        <div class="partner-logo"><img src="<?= base_url('public/images/demo/partners-6.png') ?>" alt="partners"></div>
                    </div>
                    <div class="item">
                        <div class="partner-logo"><img src="<?= base_url('public/images/demo/partners-7.png') ?>" alt="partners"></div>
                    </div>
                </div>
            </div>
        </div>
